...
//    detector->detect ( img_2,keypoints_2);
    ...
    //-- Descriptor matching through Hamming distance
    ...
    // Find minimum and maximum distances for matched pairs
    ...
    // If distance more than twice of minimum then wrong pair. lower limit 30
    ...
    imshow ( "All matched pairs", img_match );
    imwrite("all_matches.png", img_match);
    imshow ( "Matched pairs after optimization", img_goodmatch );
...
int main(int argc, char *argv[])
{
    ...
    outputFile = "mask.png";
    VideoCapture cap;// Modify according to camera port ID
    VideoWriter video;
    Mat frame, blob;
